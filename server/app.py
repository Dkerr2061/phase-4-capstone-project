...
class ArtistByID(Resource):
    ...
    def get(self, id):
        ...
        if artist:
            ...
            body["albums"] = [
                album.to_dict(only=("id", "name", "year", "song"))
...
class AllAlbums(Resource):
    ...
    def get(self):
        ...
        body = [
            album.to_dict(only=("id", "name", "year", "song", "artist_name"))
            for album in albums
        ]
        return make_response(body, 200)
    ...
    def get(self, id):
        ...
        if album:
            try:
                ...
                body["artists"] = [
                    artist.to_dict(only=("id", "name")) for artist in album.artists
                ]
                return make_response(body, 200)
            except:
...
class AllReviews(Resource):
    ...
    def get(self):
        ...
        body = [
            review.to_dict(rules=("-artist.reviews", "-album.reviews"))
