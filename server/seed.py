...
if __name__ == '__main__':
    ...
    with app.app_context():
        ...
        album1 = Album(name="Lateralus", year=2001, song="Schism")
        album2 = Album(name="Dark Side of the Moon", year=1973, song="Time")
        album3 = Album(name="Skin", year=2016, song="Say it")
        album4 = Album(name="Obras Cumbres", year=2001, song="De musica ligera")
        album5 = Album(name="Badlands", year=2015, song="Gasoline")
        album6 = Album(name="FLCL", year=2003, song="Hybrid Rainbow")
        album7 = Album(name="Stand Alone Complex", year=2011, song="Inner Universe")
        album8 = Album(name="The Predator", year=1992, song="It was a good day")
        album9 = Album(name="2001", year=1999, song="Still Dre")
        album10 = Album(name="They can't all be Zingers", year=2006, song="Blue collar tweekers")
        album11 = Album(name="Bajo y Bateria", year=2023, song="Bajo y Bateria")
        album12 = Album(name="Battle of Los Angeles", year=1999, song="Guerrilla Radio")
